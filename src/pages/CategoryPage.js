...
export default function CategoryPage() {
  ...
  // Retrieve data of Collection with specific 'Where' from FireStore
  useEffect(() => {
  ...
  // Handle get more Listing from useEffect
    ...
    <div className="category">
      <header>
        <p className="pageHeader">
          {typeCategory === "rent" ? "Places for rent" : "Places for sale"}
        </p>
      </header>
      ...
      {loading ? (
        ...
        <p>No listings for {typeCategory}</p>
      )}
    </div>
  );
}
